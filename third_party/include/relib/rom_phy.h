...
typedef struct phy_func_tab g_phyFuns_t;

g_phyFuns_t *phy_get_romfuncs(void);

// This extends the DWARF symbol to include the struct type for Ghidra.
g_phyFuns_t *g_phyFuns;
